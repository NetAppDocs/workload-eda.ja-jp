...
AI分析の利用可否は、アカウント設定によって異なります。

* *NetApp管理AIクレジットが有効*：Bedrockの追加設定なしでAI分析を実行できます。
* *管理者により無効化されています*：AIオプションは利用できません。


NetApp が管理する AI クレジットが有効になっている場合でも、月間予算に達すると、AI 分析は利用できなくなり、メッセージが表示されます。
